...
eval_split = "minitest_first_40"  # [minitest, test, minitest_first_40, scienceqa_chameleon_gpt4_test_failure_cases]
...
model_vqa_science = [
    ...
    "--question-file", "/l/users/guanglin.zhou/llava/playground/data/eval/scienceqa/llava_{}_{}.json".format(
